...
const Login = () => {
   ...
   return (
      <div className="md:min-h-screen pt-3 md:pt-0 flex justify-center md:gap-x-10 items-center bg-gray-100 text-black px-4 font-Onset">
         <img className="w-[400px] hidden md:block" src={loginBanner} alt="Login Banner" />
            ...
            <form onSubmit={handleFormSubmit} className="space-y-5">
               <div>
                  ...
                  <input
                     type="email"
                     name="email"
                     className="w-full px-4 py-2 rounded border border-gray-400 focus:outline-0"
               ...
               <div>
                  ...
                  <div className="join w-full border border-gray-400 px-1 rounded">
                     ...
                     <button
                        ...
                        className="join-item cursor-pointer px-2"
                     >
                        {showPass ? <IoMdEye className="size-6" /> : <IoMdEyeOff className="size-6" />}
                     </button>
                  </div>
               </div>
               ...
               <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-orange-600 hover:bg-orange-700 text-white font-semibold py-2 rounded-md transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
               >
